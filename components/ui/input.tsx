...
export const LabeledInput = forwardRef(function LabeledInput(
  { label, inputProps, labelProps, helperText, error, className, suffix }: LabeledInputProps,
  ref: React.ForwardedRef<HTMLInputElement>,
) {
  return (
    <div className={cn('flex flex-col', className)}>
      ...
      <div className="mt-1">
        <Input
          ref={ref}
          className="block w-full rounded-md shadow-xs focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
          {...inputProps}
          suffix={suffix}
        />
      </div>
