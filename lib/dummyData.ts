...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: "$45",
    description:
      "A durable and spacious canvas tote bag, perfect for daily errands and shopping.",
    options: "Natural",
    imageSrc:
      "https://tailwindui.com/plus/img/ecommerce-images/category-page-02-image-card-06.jpg",
  ...
  },
  {
    ...
    price: "$25",
    description:
      "Keep your head warm with our classic wool beanie. Perfect for cold weather.",
    options: "3 colors",
    imageSrc:
