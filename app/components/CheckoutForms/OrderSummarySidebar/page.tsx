...
const products = [
  {
    ...
    size: "L",
    imageSrc:
      "https://tailwindui.com/plus/img/ecommerce-images/checkout-form-04-product-01.jpg",
    imageAlt:
                ...
                {products.map((product) => (
                  <li key={product.id} className="flex space-x-6 py-6">
                    <img
                      ...
                      className="size-40 flex-none rounded-md bg-gray-200 object-cover object-center"
                    />
